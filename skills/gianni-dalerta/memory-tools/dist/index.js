...
import { vectorDimsForModel } from './types.js';
...
const memoryToolsPlugin = {
    ...
    register(api) {
        ...
        api.registerTool({
            ...
            execute: (id, params) => tools.memory_store.execute(id, params, {}),
        }, { name: 'memory_store' });
        api.registerTool({
            ...
            execute: (id, params) => tools.memory_update.execute(id, params),
        }, { name: 'memory_update' });
        api.registerTool({
            ...
            execute: (id, params) => tools.memory_forget.execute(id, params),
        }, { name: 'memory_forget' });
        api.registerTool({
            ...
            execute: (id, params) => tools.memory_search.execute(id, params),
        }, { name: 'memory_search' });
        api.registerTool({
            ...
            execute: (id, params) => tools.memory_summarize.execute(id, params),
        ...
        api.registerTool({
            ...
            execute: (id, params) => tools.memory_list.execute(id, params),
        }, { name: 'memory_list' });
        // ═══════════════════════════════════════════════════════════════════════
        // Lifecycle Hooks
        // ═══════════════════════════════════════════════════════════════════════
